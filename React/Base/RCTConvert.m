...
//将js传递过来的数据进行类型转换
//针对NSMethodSignature *typeSignature = [[RCTConvert class] methodSignatureForSelector:type]; RCT_CASE(_value, _type)调用
//用来设置view的color属性，color格式有多种，这里做兼容处理：[123,123,123,123]、0xFF00FF
